# 芳策雲  AromaMind – Phase 1 (MVP)  系統需求文件 (SRD)
...
此文件定義「芳策雲  AromaMind」第一階段 (Minimum Viable Product, MVP) 的產品目標、功能範圍、系統架構與驗收標準，供產品、設計、開發、測試與利益關係人對齊共同基準。

## 2  產品概述

芳策雲  AromaMind 是一款 SaaS  雲端平台，協助專業芳療師 (個體戶與企業團隊) 進行客戶問診、配方管理與紀錄。平台核心價值：
